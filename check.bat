...
set "PS_SCRIPT=%PROJECT_DIR%\app\check.ps1"
set "LOG_DIR=%PROJECT_DIR%\runtime\logs"
set "LAUNCHER_LOG=%LOG_DIR%\check-launcher.log"
...
if not exist "%PS_SCRIPT%" (
    echo [ERRO] check.ps1 nao encontrado. >> "%LAUNCHER_LOG%"
